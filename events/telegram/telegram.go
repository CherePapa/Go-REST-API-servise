...
var ErrUnknowEventType = errors.New("unknown event type")

var ErrUnknowMetaType = errors.New("unknown meta type")
...
func (p *Processor) Process(event events.Event) error {
	...
	default:
		return e.Wrap("cant process message", ErrUnknowEventType)
	}
}
...
func meta(event events.Event) (Meta, error) {
	...
	if !ok {
		return Meta{}, e.Wrap("cant meta message", ErrUnknowMetaType)
	}
	return res, nil
}
